...
nlp = StanfordCoreNLP(
    '/home/fanfu/newdisk/Dropbox/city_session/individual project/project/stanford-corenlp-full-2017-06-09')
...
def main(params):
    ...
    for i, img in enumerate(imgs):
        ...
        if params['split'] == 'robust' or params['split'] == 'noc':
            ...
            if img[
                'split'] == 'val' and count < 1000:  # we use 1000 image from val as validation, and the rest as train.
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='data/coco/dataset_coco.json',
